...
/****************************************************************/
#ifndef ELECTRONUTRALITY_H
#define ELECTRONUTRALITY_H

#include "Kernel.h"
#include "DerivativeMaterialInterface.h"

class Electronutrality;

template <>
InputParameters validParams<Electronutrality>();

class Electronutrality: public DerivativeMaterialInterface<Kernel>
{
public:
  Electronutrality(const InputParameters & parameters);
